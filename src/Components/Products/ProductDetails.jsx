    ...
    <>
      <div className="w-[1220px] mx-auto">
        ...
        <div className="container mx-auto mt-5 flex gap-16 bg-slate-400 h-[80vh] items-center rounded-lg">
          <div className="ml-10 ">
            <img
              className=" rounded-[50px] w-[450px] h-[550px]"
          ...
          <div className="flex flex-col gap-3 items-start mt-5">
            ...
            <p className="w-[550px] text-lg font-serif font-medium text-bt-color">
              {productData.description}
            </p>
            <button
              onClick={() => dispatch(addTolist(productData))}
        ...
        <h2 className="text-xl font-semibold text-center text-slate-400 mb-[50px]  ">
          New Collection New Modern Design
        </h2>
